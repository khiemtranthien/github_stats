...
db.getCollection('issuesEvent').find({"repo.id": 20313056, "payload.action": {"$ne": "opened"}});
db.getCollection('issuesEvent').find({"repo.id": 153640774, "payload.issue.id": 482553673});
